1. We'll be making changes to `src/__tests__/jest-dom.js` to showcase various
   testing styles. The most up to date version of the code will always be in
   that file, but here's a peek
